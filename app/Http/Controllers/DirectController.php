    ...
    public function login(Request $request)
    {
        ...
        if (auth()->attempt($credentials)) {
                ...
                if (auth()->attempt($credentials)) {
                    ...
                    return redirect()->route('direct.home'); // Replace 'landing.page' with your actual route name
                }
        ...
        return redirect()->route('direct.register'); // Replace 'registration.page' with your actual route name
